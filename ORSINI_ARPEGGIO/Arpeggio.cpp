...
void  Arpeggio::makeVelocities( byte *sequence, byte vel){
	...
	switch(for_case){
	        case 0:
				setVelDown( sequence, map(vel, 0, 127/4, 0, 127 ) );
			break;
			case 1:
				setVelRand( sequence, map(vel, 127/4, 127/2, 0, 127 ) );
			break;
			case 2:
				setVelUp( sequence, map(vel, 127/2, 127-(127/4), 0, 127 ) );
			break;
			case 3:
				setVelVal( sequence, map(vel, 127-(127/4), 127, 0, 127 ) );
			break;
